    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      <form onSubmit={submit} className="w-full max-w-sm rounded-2xl border border-zinc-800 bg-zinc-900/60 p-8 space-y-4">
        ...
        <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Password"
          className="w-full px-3 py-2 rounded-lg bg-zinc-800 border border-zinc-700 text-sm text-zinc-200 focus:border-indigo-500 outline-none" />
        <button type="submit" disabled={busy} className="w-full py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium disabled:opacity-50">
        ...
        <button type="button" onClick={loginWithGoogle}
          className="w-full py-2 rounded-lg bg-white text-zinc-800 text-sm font-medium hover:bg-zinc-100 flex items-center justify-center gap-2">
