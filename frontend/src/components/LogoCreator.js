...
import { Palette, Wand2, Download, Check, Loader2, Sparkles, LayoutTemplate, Cpu } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-zinc-400 mt-1 text-sm">
          Generate brand logos with AI and templates. Optional — skip if you already have one.
        </p>
      </div>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Your AI personal trainer"
                  className="w-full bg-zinc-900/50 border border-zinc-800 rounded-lg px-4 py-2.5 text-zinc-100 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all placeholder:text-zinc-600"
                />
              </div>
            </div>
        ...
        <div className="lg:col-span-2">
          ...
          {results && !loading && (
            <div className="space-y-6">
              ...
              {/* Selected action bar */}
              {selected && (
                <div className="bg-indigo-950/30 border border-indigo-500/30 rounded-xl p-4 flex flex-wrap items-center justify-between gap-3">
                  <div className="flex items-center gap-2">
                    <Check className="w-5 h-5 text-indigo-400 flex-shrink-0" />
                    <span className="text-sm text-indigo-300">Logo selected — ready to download</span>
                  </div>
                  <button
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 left-2 flex gap-1">
        {isAI && (
          <span className="px-1.5 py-0.5 bg-indigo-600/90 text-white text-xs rounded font-medium">AI</span>
        )}
        {isSelected && (
          <span className="px-1.5 py-0.5 bg-green-600/90 text-white text-xs rounded font-medium">Selected</span>
        )}
      </div>
