...
This project is indexed by GitNexus as **jobhuntpro_marketing** (1268 symbols, 3403 relationships, 63 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
