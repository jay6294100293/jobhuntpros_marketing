...
This project is indexed by GitNexus as **jobhuntpro_marketing** (1166 symbols, 3155 relationships, 57 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
